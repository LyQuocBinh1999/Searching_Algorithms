...
class Maze:
    ...
    def bonus_oriented_heuristic(self, node):
        ...
        v1 = (min_cluster_coordinate[0] - self.start_coordinate[0], min_cluster_coordinate[1] - self.start_coordinate[1])
        v2 = (self.end_coordinate[0] - self.start_coordinate[0], self.end_coordinate[1] - self.start_coordinate[1])
